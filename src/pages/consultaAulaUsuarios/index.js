...
export default function consultaAulaUsuarios() {
  ...
  useEffect(() => {
    let url = `/aula_usuarios?_page=${page}&_limit=${limit}&_sort=${sort}&_order=${order}`;
        ...
        <div>
          <div className="BarraCimaAlunos">
            ...
            <div>
              ...
              >
                ...
                <option value="id"> Aula ID</option>
          ...
          <div className="DivTabelaAlunos">
            <table className="TabelaAlunos">
              <caption className="tituloaluno">Consultar Aula Usuários</caption>
              <thead>
                <th>ID</th>
                <th>Aula ID</th>
                <th>Usuário ID</th>
              ...
              {data.map((element) => {
                return (
                  <Tr data={element}>
                    ...
                    <td className="nomealun" data-cell="usu_id">
                      {element.usu_id}
                    </td>
          ...
          <div className="BarraBaixoAlunos">
            ...
            <div className="espaco">
              ...
              >
                <option value="id">ID</option>
                <option value="aul_id">Aula ID</option>
                <option value="usu_id">Usuário ID</option>
