...
export default function consultaAulaUsuarios() {
  ...
  useEffect(() => {
    let url = `/curso_usuarios?_page=${page}&_limit=${limit}&_sort=${sort}&_order=${order}`;
        ...
        <div>
          ...
          <div className="DivTabelaAlunos">
            <table className="TabelaAlunos">
              <caption className="tituloaluno">
                Consultar Curso Usuários
              </caption>
              <thead>
                <th>Id</th>
                <th>Curso ID</th>
              ...
              {data.map((element) => {
                return (
                  <Tr data={element}>
                    ...
                    <td className="nomealun" data-cell="cur_id">
                      {element.cur_id}
                    </td>
