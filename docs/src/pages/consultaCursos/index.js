...
export default function consultaAulaUsuarios() {
  ...
  useEffect(() => {
    let url = `/cursos?_page=${page}&_limit=${limit}&_sort=${sort}&_order=${order}`;
        ...
        <div>
          <div className="BarraCimaAlunos">
            ...
            <div>
              ...
              >
                <option value="cur_id">ID</option>
                <option value="cur_nome">Curso</option>
                <option value="cur_cargahorariatotal">Carga Horária</option>
          ...
          <div className="DivTabelaAlunos">
            <table className="TabelaAlunos">
              <caption className="tituloaluno">Consultar Cursos</caption>
              <thead>
                <th>Id</th>
                <th>Curso</th>
                <th>Carga Horária</th>
              ...
              {data.map((element) => {
                return (
                  <Tr data={element}>
                    <td className="idalun" data-cell="cur_id">
                      {element.cur_id}
                    </td>
